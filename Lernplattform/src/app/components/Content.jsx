...
export function Content (props){
  ...
  useEffect(() => {
    if(props.selectedtab == "catalogButton"){
      setContent(<Course courses={props.content} selectedtab={props.selectedtab}/>);
    }
    if(props.selectedtab == "registerButton"){
      setContent(<RegisterLoginForm accounts={props.content} newAccountForServer={sendNewAccountToApp} isLoginView={true} onToggleLoginView={handleToggleLoginView} setViewAfterValidation={handleViewAfterValidation}/>);
    }
    if(props.selectedtab == "signInButton"){
      setContent(<RegisterLoginForm  accounts={props.content} newAccountForServer={sendNewAccountToApp} isLoginView={false} onToggleLoginView={handleToggleLoginView} setViewAfterValidation={handleViewAfterValidation}/>);
    }
